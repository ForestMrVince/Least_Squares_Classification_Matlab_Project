...
xlswrite('results.xlsx',txt_Line_1,'训练集测试结果','A1');
xlswrite('results.xlsx',txt_Line_2,'训练集测试结果','A2');
xlswrite('results.xlsx',txt_Line_3,'训练集测试结果','A3');
xlswrite('results.xlsx',txt_Line_4,'训练集测试结果','A4');
xlswrite('results.xlsx',train_table,'训练集测试结果','B2');
...
xlswrite('results.xlsx',txt_Line_1,'测试集测试结果','A1');
xlswrite('results.xlsx',txt_Line_2,'测试集测试结果','A2');
xlswrite('results.xlsx',txt_Line_3,'测试集测试结果','A3');
xlswrite('results.xlsx',txt_Line_4,'测试集测试结果','A4');
xlswrite('results.xlsx',test_table,'测试集测试结果','B2');
